package com.guyongzhe.shixun.common;
...
public class ApiResponse implements Serializable {
     ...
     * @return
     */
    public static ApiResponse ofError(){return of(Status.ERROR.getCode(), null, null);}
     ...
     * @return
     */
    public static ApiResponse ofError(String message){return of(Status.ERROR.getCode(), message, null);}
