...
import com.guyongzhe.shixun.common.Consts;
import com.guyongzhe.shixun.common.Status;
import com.guyongzhe.shixun.config.security.JwtConfig;
...
public class JwtUtil {
     ...
     * @return JWT
     */
    public String createJWT(Boolean rememberMe, Integer id, String subject) {
        Date now = new Date();
    ...
    public String createJWT(Authentication authentication, Boolean rememberMe) {
        ...
        return createJWT(rememberMe, userPrincipal.getUser().getId(), userPrincipal.getUsername());
    }
